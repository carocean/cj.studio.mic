...
@CjService(name = "/onByeConsole.service")
public class OnByeConsole implements IGatewayAppSiteWayWebView {
	...
	public void flow(Frame frame, Circuit circuit, IGatewayAppSiteResource resource) throws CircuitException {
		...
		Frame f = new Frame(input,"notify /node/onByeConsole.service mic/1.0");
